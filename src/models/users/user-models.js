...
async function findBy(filter) {
  if (
    JSON.stringify(Object.keys(filter).sort()) === JSON.stringify(['latitude', 'longitude', 'radius'].sort())
  ) {
    return await findUsersWithinRadius(filter.radius, filter.latitude, filter.longitude);
  } else {
